...
export class ResetVisitorService {
    ...
    async resetVisitorData() {
        ...
        sql += `update m_visitor_slot set visitor_record_id = null,visitor_record_uuid = null,status_flag = 'N';`
        sql += `update m_card set visitor_record_id = null,visitor_record_uuid = null,status_flag = 'N';`
