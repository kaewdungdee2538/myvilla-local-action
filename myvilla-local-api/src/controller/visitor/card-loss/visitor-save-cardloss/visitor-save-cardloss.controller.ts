...
export class VisitorSaveCardlossController {
  ...
  async saveCardLoss(@UploadedFiles() files, @Body() body) {
    ...
    //---------------------Middle ware
    const middlewareSaveCardLoss = this.VsCardLossSaveMiddleware.checkValues(
      body,
    );
    ...
    if (employeeObj)
      //---------------------Save
      return await this.visitorCardlossService.saveCardloss(
        body,
        imagesNameObj,
        employeeObj,
      );
  ...
  async saveCardLossNotOut(@UploadedFiles() files, @Body() body) {
    ...
    const middlewareForCheckCardBefore = await this.VsCardLossSaveMiddleware.checkCardBefore(
      body,
    );
    ...
    if (employeeObj)
      //---------------------Save
      return await this.visitorCardlossService.saveCardlossNotOut(
        body,
        imagesNameObj,
        employeeObj,
      );
