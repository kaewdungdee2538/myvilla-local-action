...
export declare class vsActionOutVerifyEstampMiddleware implements NestMiddleware {
    ...
    checkValues(body: any): Promise<string>;
    checkEstampVisitorOut(body: any): Promise<string>;
}
